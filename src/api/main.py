...
def _payload(results, source, packets_read, alerts, devices=()):
    ...
    # One point per conversation. FlowTable already merges the two directions,
    # and the key carries the direction it was opened in, so dst_port is the
    # side that was connected to.
    points = [
